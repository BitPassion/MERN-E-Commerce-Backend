...
The frontend of the application is built with ReactJS, Material UI, React-router-dom,ContextAPI. The source code for the frontend can be found at [https://github.com/Saurabh-8585/MERN-E-Commerce-Frontend](https://github.com/BitPassion/MERN-E-Commerce-Frontend).
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/BitPassion/MERN-E-Commerce-Backend.git
   ```
